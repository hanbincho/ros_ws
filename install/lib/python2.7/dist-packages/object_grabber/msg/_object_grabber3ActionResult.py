...
"""autogenerated by genpy from object_grabber/object_grabber3ActionResult.msg. Do not edit."""
import sys
...
class object_grabber3ActionResult(genpy.Message):
  _md5sum = "7601dfabb9ed9c7837af8d40f6a082ef"
  _type = "object_grabber/object_grabber3ActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','object_grabber/object_grabber3Result']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_grabber3ActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = object_grabber.msg.object_grabber3Result()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = object_grabber.msg.object_grabber3Result()
