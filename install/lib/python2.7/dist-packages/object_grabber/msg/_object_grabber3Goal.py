...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.gripper_test_params))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.object_frame.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.gripper_test_params = struct.unpack(pattern, str[start:end])
      return self
