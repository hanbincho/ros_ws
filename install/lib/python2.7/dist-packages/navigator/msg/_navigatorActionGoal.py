...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.goal.location_code, _x.goal.desired_pose.header.seq, _x.goal.desired_pose.header.stamp.secs, _x.goal.desired_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.location_code, _x.goal.desired_pose.header.seq, _x.goal.desired_pose.header.stamp.secs, _x.goal.desired_pose.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
