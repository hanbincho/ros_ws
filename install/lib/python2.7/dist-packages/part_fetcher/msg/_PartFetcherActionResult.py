...
"""autogenerated by genpy from part_fetcher/PartFetcherActionResult.msg. Do not edit."""
import sys
...
class PartFetcherActionResult(genpy.Message):
  _md5sum = "082631993aca122fab621d2e98be710b"
  _type = "part_fetcher/PartFetcherActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','part_fetcher/PartFetcherResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PartFetcherActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = part_fetcher.msg.PartFetcherResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = part_fetcher.msg.PartFetcherResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.rtn_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.rtn_code,) = _get_struct_i().unpack(str[start:end])
      return self
