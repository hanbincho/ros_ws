...
"""autogenerated by genpy from example_trajectory/TrajActionAction.msg. Do not edit."""
import sys
...
import example_trajectory.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class TrajActionAction(genpy.Message):
  _md5sum = "63ba343e827fda625841c0ba811b4b6d"
  _type = "example_trajectory/TrajActionAction"
...
"""
  ...
  _slot_types = ['example_trajectory/TrajActionActionGoal','example_trajectory/TrajActionActionResult','example_trajectory/TrajActionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajActionAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = example_trajectory.msg.TrajActionActionGoal()
      if self.action_result is None:
        self.action_result = example_trajectory.msg.TrajActionActionResult()
      if self.action_feedback is None:
        self.action_feedback = example_trajectory.msg.TrajActionActionFeedback()
    else:
      self.action_goal = example_trajectory.msg.TrajActionActionGoal()
      self.action_result = example_trajectory.msg.TrajActionActionResult()
      self.action_feedback = example_trajectory.msg.TrajActionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_result.result.rtn_status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.rtn_status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
