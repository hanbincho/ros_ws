...
"""autogenerated by genpy from coordinator/ManipTaskActionFeedback.msg. Do not edit."""
import sys
...
class ManipTaskActionFeedback(genpy.Message):
  _md5sum = "4f8cf0c1677a90389b42d9706c403ed6"
  _type = "coordinator/ManipTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','coordinator/ManipTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ManipTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = coordinator.msg.ManipTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = coordinator.msg.ManipTaskFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.feedback.feedback_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback_status,) = _get_struct_i().unpack(str[start:end])
      return self
