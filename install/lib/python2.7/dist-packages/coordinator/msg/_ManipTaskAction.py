...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.action_feedback.feedback.feedback_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.pickup_frame.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.dropoff_frame.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.gripper_goal_frame.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.des_gripper_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
