...
"""autogenerated by genpy from arm7dof_traj_as/trajActionGoal.msg. Do not edit."""
import sys
...
class trajActionGoal(genpy.Message):
  ...
  _type = "arm7dof_traj_as/trajActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','arm7dof_traj_as/trajGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = arm7dof_traj_as.msg.trajGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = arm7dof_traj_as.msg.trajGoal()
