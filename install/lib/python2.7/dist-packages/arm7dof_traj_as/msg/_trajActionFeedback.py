...
"""autogenerated by genpy from arm7dof_traj_as/trajActionFeedback.msg. Do not edit."""
import sys
...
class trajActionFeedback(genpy.Message):
  ...
  _type = "arm7dof_traj_as/trajActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arm7dof_traj_as/trajFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = arm7dof_traj_as.msg.trajFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = arm7dof_traj_as.msg.trajFeedback()
