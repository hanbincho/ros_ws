...
"""autogenerated by genpy from baxter_trajectory_streamer/trajActionResult.msg. Do not edit."""
import sys
...
class trajActionResult(genpy.Message):
  ...
  _type = "baxter_trajectory_streamer/trajActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','baxter_trajectory_streamer/trajResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = baxter_trajectory_streamer.msg.trajResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = baxter_trajectory_streamer.msg.trajResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.return_val))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.return_val,) = _get_struct_i().unpack(str[start:end])
      return self
