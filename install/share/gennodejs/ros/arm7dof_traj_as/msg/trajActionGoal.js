...
class trajActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = trajGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += trajGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new trajActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = trajGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new trajGoal()
    }
