...
class TrajActionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TrajActionFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TrajActionActionFeedback
    ...
    bufferOffset = TrajActionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TrajActionActionFeedback
    let len;
    let data = new TrajActionActionFeedback(null);
    ...
    data.feedback = TrajActionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajActionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TrajActionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TrajActionFeedback()
    }
...
module.exports = TrajActionActionFeedback;
