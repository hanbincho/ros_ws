...
let ManipTaskResult = require('./ManipTaskResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ManipTaskActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ManipTaskResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ManipTaskResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ManipTaskResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ManipTaskActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ManipTaskResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ManipTaskResult()
    }
...
module.exports = ManipTaskActionResult;
