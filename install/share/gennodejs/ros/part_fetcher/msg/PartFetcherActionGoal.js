...
let PartFetcherGoal = require('./PartFetcherGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class PartFetcherActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PartFetcherGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PartFetcherGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PartFetcherActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PartFetcherGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PartFetcherGoal()
    }
...
module.exports = PartFetcherActionGoal;
