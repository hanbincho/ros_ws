...
{
    // ROS set-ups:
    ros::init(argc, argv, "traj_point_space_control"); //node name
    ...
    trajectory_point6.time_from_start = ros::Duration(13.0); //2 seconds to arrive, from previous point  
     ...
     trajectory_point1.positions[0] = 1.2;
     trajectory_point1.positions[1] = 1.0;
     trajectory_point1.positions[2] = 0.0;
     
     trajectory_point2.positions[0] = 1.2;
     trajectory_point2.positions[1] = 1.0;
     trajectory_point2.positions[2] = 0.75;

     trajectory_point3.positions[0] = 0.8;
     trajectory_point3.positions[1] = 1.0;
     trajectory_point3.positions[2] = 0.0;
     
     trajectory_point4.positions[0] = 0.6;
     trajectory_point4.positions[1] = 1.0;
     trajectory_point4.positions[2] = 0.50; 

     trajectory_point5.positions[0] = 1.2;
     trajectory_point5.positions[1] = 1.0;
     trajectory_point5.positions[2] = 0.4;

     trajectory_point6.positions[0] = 0.8;
     trajectory_point6.positions[1] = 1.0;
     trajectory_point6.positions[2] = 0.20;
