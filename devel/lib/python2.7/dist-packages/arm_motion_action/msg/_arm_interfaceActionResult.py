...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.segmented_path_arrival_times))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.result.computed_arrival_time))
      length = len(self.result.q_arm)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.result.q_arm))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.result.segmented_path_arrival_times = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.result.q_arm = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.result.current_pose_gripper.header.frame_id = str[start:end].decode('utf-8')
      else:
