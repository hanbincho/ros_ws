...
"""autogenerated by genpy from arm_motion_action/arm_interfaceActionFeedback.msg. Do not edit."""
import sys
...
class arm_interfaceActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "arm_motion_action/arm_interfaceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arm_motion_action/arm_interfaceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(arm_interfaceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = arm_motion_action.msg.arm_interfaceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = arm_motion_action.msg.arm_interfaceFeedback()
