...
"""autogenerated by genpy from navigator/navigatorActionFeedback.msg. Do not edit."""
import sys
...
class navigatorActionFeedback(genpy.Message):
  ...
  _type = "navigator/navigatorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navigator/navigatorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = navigator.msg.navigatorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = navigator.msg.navigatorFeedback()
