...
class navigatorActionResult(genpy.Message):
  _md5sum = "526b886c65668f9440ec7f7d90b44e44"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.return_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.return_code,) = _get_struct_i().unpack(str[start:end])
      return self
