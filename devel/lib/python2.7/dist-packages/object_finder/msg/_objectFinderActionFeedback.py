...
"""autogenerated by genpy from object_finder/objectFinderActionFeedback.msg. Do not edit."""
import sys
...
class objectFinderActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "object_finder/objectFinderActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','object_finder/objectFinderFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(objectFinderActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = object_finder.msg.objectFinderFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = object_finder.msg.objectFinderFeedback()
