...
"""autogenerated by genpy from arm7dof_traj_as/trajActionResult.msg. Do not edit."""
import sys
...
class trajActionResult(genpy.Message):
  ...
  _type = "arm7dof_traj_as/trajActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arm7dof_traj_as/trajResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = arm7dof_traj_as.msg.trajResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = arm7dof_traj_as.msg.trajResult()
