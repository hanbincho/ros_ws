...
"""autogenerated by genpy from sin_commander_action_server/sinActionFeedback.msg. Do not edit."""
import sys
...
class sinActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "sin_commander_action_server/sinActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sin_commander_action_server/sinFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(sinActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = sin_commander_action_server.msg.sinFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sin_commander_action_server.msg.sinFeedback()
