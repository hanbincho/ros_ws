...
"""autogenerated by genpy from example_trajectory/TrajActionActionGoal.msg. Do not edit."""
import sys
...
class TrajActionActionGoal(genpy.Message):
  _md5sum = "a99e83ef6185f9fdd7693efe99623a86"
  _type = "example_trajectory/TrajActionActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','example_trajectory/TrajActionGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajActionActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = example_trajectory.msg.TrajActionGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = example_trajectory.msg.TrajActionGoal()
