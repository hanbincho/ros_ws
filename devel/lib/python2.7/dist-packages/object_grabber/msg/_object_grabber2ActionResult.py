...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.result.return_code, _x.result.des_flange_pose_stamped_wrt_torso.header.seq, _x.result.des_flange_pose_stamped_wrt_torso.header.stamp.secs, _x.result.des_flange_pose_stamped_wrt_torso.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.return_code, _x.result.des_flange_pose_stamped_wrt_torso.header.seq, _x.result.des_flange_pose_stamped_wrt_torso.header.stamp.secs, _x.result.des_flange_pose_stamped_wrt_torso.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.result.des_flange_pose_stamped_wrt_torso.pose.position.x, _x.result.des_flange_pose_stamped_wrt_torso.pose.position.y, _x.result.des_flange_pose_stamped_wrt_torso.pose.position.z, _x.result.des_flange_pose_stamped_wrt_torso.pose.orientation.x, _x.result.des_flange_pose_stamped_wrt_torso.pose.orientation.y, _x.result.des_flange_pose_stamped_wrt_torso.pose.orientation.z, _x.result.des_flange_pose_stamped_wrt_torso.pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      return self
