...
"""autogenerated by genpy from baxter_trajectory_streamer/trajAction.msg. Do not edit."""
import sys
...
class trajAction(genpy.Message):
  ...
  _type = "baxter_trajectory_streamer/trajAction"
...
"""
  ...
  _slot_types = ['baxter_trajectory_streamer/trajActionGoal','baxter_trajectory_streamer/trajActionResult','baxter_trajectory_streamer/trajActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = baxter_trajectory_streamer.msg.trajActionGoal()
      if self.action_result is None:
        self.action_result = baxter_trajectory_streamer.msg.trajActionResult()
      if self.action_feedback is None:
        self.action_feedback = baxter_trajectory_streamer.msg.trajActionFeedback()
    else:
      self.action_goal = baxter_trajectory_streamer.msg.trajActionGoal()
      self.action_result = baxter_trajectory_streamer.msg.trajActionResult()
      self.action_feedback = baxter_trajectory_streamer.msg.trajActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.action_result.result.return_val, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.return_val, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_i3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
