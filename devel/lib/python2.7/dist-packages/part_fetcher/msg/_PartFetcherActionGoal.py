...
"""autogenerated by genpy from part_fetcher/PartFetcherActionGoal.msg. Do not edit."""
import sys
...
class PartFetcherActionGoal(genpy.Message):
  _md5sum = "2366697920dc0c58c66f2a783406a441"
  _type = "part_fetcher/PartFetcherActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','part_fetcher/PartFetcherGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PartFetcherActionGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_i3I().pack(_x.goal.object_id, _x.goal.object_frame.header.seq, _x.goal.object_frame.header.stamp.secs, _x.goal.object_frame.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_7d3I().pack(_x.goal.object_frame.pose.position.x, _x.goal.object_frame.pose.position.y, _x.goal.object_frame.pose.position.z, _x.goal.object_frame.pose.orientation.x, _x.goal.object_frame.pose.orientation.y, _x.goal.object_frame.pose.orientation.z, _x.goal.object_frame.pose.orientation.w, _x.goal.desired_frame.header.seq, _x.goal.desired_frame.header.stamp.secs, _x.goal.desired_frame.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.object_frame.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.desired_frame.header.frame_id = str[start:end].decode('utf-8')
      else:
