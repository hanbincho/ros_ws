...
"""autogenerated by genpy from part_fetcher/PartFetcherActionFeedback.msg. Do not edit."""
import sys
...
class PartFetcherActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "part_fetcher/PartFetcherActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','part_fetcher/PartFetcherFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PartFetcherActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = part_fetcher.msg.PartFetcherFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = part_fetcher.msg.PartFetcherFeedback()
