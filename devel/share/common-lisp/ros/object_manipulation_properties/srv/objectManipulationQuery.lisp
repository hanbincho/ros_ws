...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<objectManipulationQuery-request>)))
  ...
  (cl:format cl:nil "~%~%~%~%uint8 TEST_PING = 0~%uint8 GRASP_STRATEGY_OPTIONS_QUERY = 1~%uint8 APPROACH_STRATEGY_OPTIONS_QUERY = 2~%uint8 DEPART_STRATEGY_OPTIONS_QUERY = 3~%~%uint8 GET_GRASP_POSE_TRANSFORMS = 10~%uint8 GET_APPROACH_POSE_TRANSFORMS = 11~%uint8 GET_DEPART_POSE_TRANSFORMS =12~%~%~%int32 GRASP_FROM_ABOVE = 0~%~%int32 GRASP_FROM_SIDE = 1~%~%~%int32 APPROACH_Z_TOOL= 11~%int32 DEPART_Z_TOOL = 12~%int32 APPROACH_LATERAL_SLIDE = 21~%int32 DEPART_LATERAL_SLIDE = 22~%~%int32 object_ID~%int32 gripper_ID~%uint8 query_code~%int32 grasp_option~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'objectManipulationQuery-request)))
  "Returns full string definition for message of type 'objectManipulationQuery-request"
  (cl:format cl:nil "~%~%~%~%uint8 TEST_PING = 0~%uint8 GRASP_STRATEGY_OPTIONS_QUERY = 1~%uint8 APPROACH_STRATEGY_OPTIONS_QUERY = 2~%uint8 DEPART_STRATEGY_OPTIONS_QUERY = 3~%~%uint8 GET_GRASP_POSE_TRANSFORMS = 10~%uint8 GET_APPROACH_POSE_TRANSFORMS = 11~%uint8 GET_DEPART_POSE_TRANSFORMS =12~%~%~%int32 GRASP_FROM_ABOVE = 0~%~%int32 GRASP_FROM_SIDE = 1~%~%~%int32 APPROACH_Z_TOOL= 11~%int32 DEPART_Z_TOOL = 12~%int32 APPROACH_LATERAL_SLIDE = 21~%int32 DEPART_LATERAL_SLIDE = 22~%~%int32 object_ID~%int32 gripper_ID~%uint8 query_code~%int32 grasp_option~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<objectManipulationQuery-response>)))
  ...
  (cl:format cl:nil "int32 QUERY_SUCCESSFUL =0~%int32 QUERY_NOT_VALID = 1~%int32 APPROACH_Z_TOOL= 11~%int32 DEPART_Z_TOOL = 12~%int32 APPROACH_LATERAL_SLIDE = 21~%int32 DEPART_LATERAL_SLIDE = 22~%~%int32 GRASP_FROM_ABOVE = 0~%~%int32 GRASP_FROM_SIDE = 1~%~%~%~%~%~%~%~%bool valid_reply~%int32[] grasp_strategy_options~%~%~%~%~%~%~%geometry_msgs/Pose[] gripper_pose_options~%~%~%~%~%~%~%~%~%~%float64[] tool_rotz_max~%float64[] tool_rotz_min~%float64[] object_rotz_max~%float64[] object_rotz_min~%float64[] tool_dz_max~%float64[] tool_dz_min~%float64[] tool_dslide_max~%float64[] tool_dslide_min~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'objectManipulationQuery-response)))
  "Returns full string definition for message of type 'objectManipulationQuery-response"
  (cl:format cl:nil "int32 QUERY_SUCCESSFUL =0~%int32 QUERY_NOT_VALID = 1~%int32 APPROACH_Z_TOOL= 11~%int32 DEPART_Z_TOOL = 12~%int32 APPROACH_LATERAL_SLIDE = 21~%int32 DEPART_LATERAL_SLIDE = 22~%~%int32 GRASP_FROM_ABOVE = 0~%~%int32 GRASP_FROM_SIDE = 1~%~%~%~%~%~%~%~%bool valid_reply~%int32[] grasp_strategy_options~%~%~%~%~%~%~%geometry_msgs/Pose[] gripper_pose_options~%~%~%~%~%~%~%~%~%~%float64[] tool_rotz_max~%float64[] tool_rotz_min~%float64[] object_rotz_max~%float64[] object_rotz_min~%float64[] tool_dz_max~%float64[] tool_dz_min~%float64[] tool_dslide_max~%float64[] tool_dslide_min~%~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
