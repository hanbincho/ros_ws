...
(cl:defmethod cl:initialize-instance :after ((m <cart_moveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cart_moveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cartesian_planner-msg:<cart_moveResult> is deprecated: use cartesian_planner-msg:cart_moveResult instead.")))

(cl:ensure-generic-function 'return_code-val :lambda-list '(m))
(cl:defmethod return_code-val ((m <cart_moveResult>))
...
(cl:defmethod computed_arrival_time-val ((m <cart_moveResult>))
...
(cl:defmethod q_arm-val ((m <cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartesian_planner-msg:q_arm-val is deprecated.  Use cartesian_planner-msg:q_arm instead.")
  (q_arm m))

(cl:ensure-generic-function 'current_pose_gripper-val :lambda-list '(m))
(cl:defmethod current_pose_gripper-val ((m <cart_moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartesian_planner-msg:current_pose_gripper-val is deprecated.  Use cartesian_planner-msg:current_pose_gripper instead.")
  (current_pose_gripper m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<cart_moveResult>)))
    "Constants for message type '<cart_moveResult>"
  '((:SUCCESS . 0)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cart_moveResult>)))
  ...
  "cartesian_planner/cart_moveResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cart_moveResult)))
  "Returns string type for a message object of type 'cart_moveResult"
  "cartesian_planner/cart_moveResult")
