...
(cl:defclass <arm_interfaceResult> (roslisp-msg-protocol:ros-message)
  ((return_code
   ...
   (err_code
    ...
    :initform 0)
   (num_path_segs
    :reader num_path_segs
    :initarg :num_path_segs
    :type cl:integer
    :initform 0)
   (segmented_path_arrival_times
    :reader segmented_path_arrival_times
    :initarg :segmented_path_arrival_times
...
(cl:ensure-generic-function 'num_path_segs-val :lambda-list '(m))
(cl:defmethod num_path_segs-val ((m <arm_interfaceResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_motion_action-msg:num_path_segs-val is deprecated.  Use arm_motion_action-msg:num_path_segs instead.")
  (num_path_segs m))

(cl:ensure-generic-function 'segmented_path_arrival_times-val :lambda-list '(m))
(cl:defmethod segmented_path_arrival_times-val ((m <arm_interfaceResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_motion_action-msg:segmented_path_arrival_times-val is deprecated.  Use arm_motion_action-msg:segmented_path_arrival_times instead.")
  (segmented_path_arrival_times m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <arm_interfaceResult>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'num_path_segs)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
    )
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'segmented_path_arrival_times))))
  ...
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-double-float-bits ele)))
   ...
   (cl:slot-value msg 'segmented_path_arrival_times))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <arm_interfaceResult>) istream)
  "Deserializes a message object of type '<arm_interfaceResult>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'num_path_segs) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'segmented_path_arrival_times) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'segmented_path_arrival_times)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<arm_interfaceResult>)))
  ...
  "e40b7949a686d121b85df18d92974567")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'arm_interfaceResult)))
  "Returns md5sum for a message object of type 'arm_interfaceResult"
  "e40b7949a686d121b85df18d92974567")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <arm_interfaceResult>))
  (cl:+ 0
     ...
     4
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'segmented_path_arrival_times) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <arm_interfaceResult>))
  ...
  (cl:list 'arm_interfaceResult
    ...
    (cl:cons ':num_path_segs (num_path_segs msg))
    (cl:cons ':segmented_path_arrival_times (segmented_path_arrival_times msg))
