...
let sinGoal = require('./sinGoal.js');
...
class sinActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = sinGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new sinActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = sinGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new sinGoal()
    }
