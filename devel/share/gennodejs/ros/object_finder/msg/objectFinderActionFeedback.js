...
let objectFinderFeedback = require('./objectFinderFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class objectFinderActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new objectFinderFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = objectFinderFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new objectFinderActionFeedback(null);
    ...
    data.feedback = objectFinderFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new objectFinderActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = objectFinderFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new objectFinderFeedback()
    }
...
module.exports = objectFinderActionFeedback;
