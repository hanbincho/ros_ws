...
let ManipTaskFeedback = require('./ManipTaskFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ManipTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ManipTaskFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ManipTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ManipTaskActionFeedback(null);
    ...
    data.feedback = ManipTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ManipTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ManipTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ManipTaskFeedback()
    }
...
module.exports = ManipTaskActionFeedback;
