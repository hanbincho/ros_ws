...
if("TRUE" STREQUAL "TRUE")
  set(mobot_urdf_SOURCE_PREFIX /home/hanbin/ros_ws/src/Part_2/mobot_urdf)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobot_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hanbin/ros_ws/src/Part_2/mobot_urdf/${idir}'.  ${_report}")
    endif()
